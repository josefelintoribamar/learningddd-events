...
public record EventRequestDTO(
    ...
    Boolean remote,
    @Pattern(regexp = "^(https?://)(www\\.)?[a-zA-Z0-9-]+(\\.[a-zA-Z]{2,63}){1,3}(/[a-zA-Z0-9._~:/?#\\[\\]@!$&'()*+,;=-]*)?$", message = "URL inválida") @NotEmpty(message = "O link para o evento deve ser informado") String eventUrl) {
}
